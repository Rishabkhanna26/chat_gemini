...
- Set env vars:
  ...
  - Optional: `REDIS_URL`, `OPENROUTER_API_KEY`, `OPENROUTER_MODEL`, `OPENROUTER_SITE_URL`, `OPENROUTER_SITE_NAME`, `WHATSAPP_USE_LEGACY_AUTOMATION`, `WHATSAPP_AI_GREETING_REQUIRED`, `WHATSAPP_AI_HISTORY_LIMIT`, `WHATSAPP_AI_AUTO_LANGUAGE`
